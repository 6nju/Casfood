	...
	changeExpandedD = () => {
	  ...
	  render() {
		...
		return (
		  ...
		  <StatusBar backgroundColor="#90D077"/>
			...
			<View>
				...
				<View  style={ [styles.formGroup, {borderColor: '#757F8C',borderBottomWidth: 1, flexDirection:'row',flexWrap:'wrap',paddingTop:11,paddingBottom:11,}] }>
				...
				<View  style={ [styles.formGroup, {borderColor: '#757F8C',borderBottomWidth: 1,paddingTop:9,paddingBottom:9,flexDirection:'row',flexWrap:'wrap',}] }>
				<View style={{width:170,}}>
        ...
        />
				...
				<View style={ [styles.formGroup, {borderColor: '#757F8C',borderBottomWidth: 1, paddingBottom:9,paddingTop:9,flexDirection:'row',flexWrap:'wrap',}] }>
				<View style={{width:170,}}>
					<Text style={{marginLeft: 10, fontWeight: 'bold',marginTop:5,}}>
							Nghề nghiệp: 
						</Text>

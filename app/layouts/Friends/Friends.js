...
class Friends extends Component {
	...
	sickClick(id) {
		if(id == 3){
			 Alert.alert('Thông báo',  'Chế độ ăn này vẫn đảm bảo tổng năng lượng tuy nhiên tỷ lệ các chất sinh năng lượng sẽ có sự thay đổi: protein(20% - 25%), glucid(45%- 55%), lipid(20% - 35%)' )
		 }
		if(id == 2){
			 Alert.alert('Thông báo',  'Chế độ ăn này vẫn đảm bảo tổng năng lượng tuy nhiên tỷ lệ các chất sinh năng lượng sẽ có sự thay đổi: protein(15% - 20%), glucid(55%- 60%), lipid(20% - 30%)' )
		 }
		 this.setState({
		  sick: id
		})
	...
	changeExpandedD = () => {
	  ...
	  _facebook_ = () => {
	  	Linking.openURL("fb-messenger://user-thread/112277957216213");
		...
		return (
		  ...
		  <StatusBar backgroundColor="#90D077"/>
			...
			<ScrollView style={[{width: width, height: height - 85 - 80}]}>	
				...
				<TouchableOpacity onPress={this._account} style={[styles.image_box]}>
			...
			<TouchableOpacity onPress={this._setting} style={[styles.image_box]}>
			...
			<TouchableOpacity onPress={this._settingtow} style={[styles.image_box]}>
			...
			<TouchableOpacity onPress={this._alert_} style={[styles.image_box]}>
			...
			<TouchableOpacity onPress={this._facebook_} style={[styles.image_box]}>
			...
			<TouchableOpacity onPress={this._logout} style={[styles.image_box]}>
				
				<Image
					style={styles.image}
                    source={ require('./imgs/dangxuat.jpg') }
